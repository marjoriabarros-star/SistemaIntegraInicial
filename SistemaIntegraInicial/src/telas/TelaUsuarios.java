...
public class TelaUsuarios extends javax.swing.JFrame {
    ...
    public TelaUsuarios() {
        ...
        setTitle("Gerenciamento de Usuários - Visitante");
        configurarPermissoes("Visitante");
        destacarBotaoAtual();
        atualizarLabelUsuario();
    }

    public TelaUsuarios(String tipoUsuario) {
        initComponents();
       setLocationRelativeTo(null);
        this.tipoUsuario = tipoUsuario;
        setTitle("Gerenciamento de Usuários - " + tipoUsuario);
    ...
    private void configurarPermissoes(String tipoUsuario) {
        ...
        btnNovoUsuario.setEnabled(podeGerenciar);
        btnBuscarUsuario.setEnabled(true); // Buscar sempre permitido
    ...
    if (btnNovoUsuario.isEnabled()) {
            new TelaCadastroUsuario(tipoUsuario).setVisible(true);
            this.dispose();
        } else {
    ...
    // Buscar sempre permitido para todos os usuários
        new TelaUsuariosCadastrados(tipoUsuario).setVisible(true);
        this.dispose();
    ...
    private void btnManuaisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManuaisActionPerformed
        new TelaManuais(tipoUsuario).setVisible(true); // Abre a tela de manuais
        this.dispose(); // Fecha o dashboard
    ...
    btnUsuario.setBackground(Color.LIGHT_GRAY); // Destacar atual
